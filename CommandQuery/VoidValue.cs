...
{
    private static readonly VoidValue ValueInit = new();

    /// <summary>
    /// Default and only value of the <see cref="VoidValue"/> type.
    /// </summary>
    public static ref readonly VoidValue Value => ref ValueInit;

    /// <summary>
    /// Task from a <see cref="VoidValue"/> type.
    /// </summary>
    public static Task<VoidValue> Task { get; } = System.Threading.Tasks.Task.FromResult(ValueInit);
